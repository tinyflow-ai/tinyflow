<script>
    ...
    // const data = `{"nodes":[{"id":"2","type":"llmNode","data":{"title":"大模型","description":"处理大模型相关问题","expand":true,"outputDefs":[{"name":"output","dataType":"String","dataTypeDisabled":true,"deleteDisabled":true}],"outType":"text"},"position":{"x":963,"y":-26},"measured":{"width":306,"height":704},"selected":false,"dragging":false},{"id":"3","type":"startNode","data":{"title":"开始节点","description":"开始定义输入参数","expand":true},"position":{"x":150,"y":25},"measured":{"width":306,"height":200},"selected":false},{"id":"4","type":"endNode","data":{"title":"结束节点","description":"结束定义输出参数","expand":true},"position":{"x":950,"y":100},"measured":{"width":306,"height":200},"selected":false},{"id":"node_iw1geiYr8trU0ttB","position":{"x":369,"y":-2},"data":{"title":"Http 请求","description":"通过 HTTP 请求获取数据","method":"post","outputDefs":[{"name":"headers","dataType":"Object","refType":"ref","nameDisabled":true,"dataTypeDisabled":true,"deleteDisabled":true,"id":"QdeoikUi7fWtNysy"},{"name":"body","dataType":"String","refType":"ref","nameDisabled":true,"deleteDisabled":true,"id":"6SGutwBT0NPBEQGl"},{"name":"statusCode","dataType":"Number","refType":"ref","nameDisabled":true,"dataTypeDisabled":true,"deleteDisabled":true,"id":"R2EC7DjZFCQOGhS7"}],"expand":true,"bodyType":"json"},"type":"httpNode","selected":true,"measured":{"width":447,"height":661},"dragging":false}],"edges":[],"viewport":{"x":250,"y":100,"zoom":1}}`
