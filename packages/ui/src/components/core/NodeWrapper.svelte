                        ...
                        <div class="settings">
                            ...
                            {#if !!data.retryEnable}
                                ...
                                <label class="input-item-inline">
                                    ...
                                    <input
                                        type="checkbox"
                                        checked={!!data.resetRetryCountAfterNormal}
                                        onchange={(event) => {
                                            const value = (event.target as any).checked;
                                            updateNodeData(currentNodeId, {
...
<div class="tf-node-wrapper">
    <div class="tf-node-wrapper-title">TinyFlow.ai</div>
    <div class="tf-node-wrapper-body">
        <Collapse
            {items}
            {activeKeys}
            onChange={(_, actionKeys) => {
